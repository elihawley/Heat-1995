...
class RestaurantPlay extends Phaser.Scene {
    constructor() {
        ...
        this.cop_side = null;
        this.cop_smile = null;
        this.robber_front = null;
        this.robber_side = null;
        this.robber_smile = null;
    ...
    create() {
        ...
        // Background Image
        this.background = this.add.tileSprite(0, 0, 400, 400, 'restaurant-background').setOrigin(0, 0);
        ...
        this.cop_front = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'cop-front').setOrigin(0, 1);;
        this.cop_side = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'cop-side').setOrigin(0, 1);;
        this.cop_smile = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'cop-smile').setOrigin(0, 1);;
        this.robber_front = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'robber-front').setOrigin(0, 1);;
        this.robber_side = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'robber-side').setOrigin(0, 1);;
        this.robber_smile = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'robber-smile').setOrigin(0, 1);;
